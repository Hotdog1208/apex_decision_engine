  ...
  return (
    <div className="max-w-md mx-auto py-12">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button type="submit" className="w-full py-2 rounded-lg bg-apex-accent text-white font-medium">Sign in</button>
      </form>
      <p className="text-slate-400 text-sm mt-4">No account? <Link to="/signup" className="text-apex-accent">Sign up</Link></p>
    </div>
  )
}
